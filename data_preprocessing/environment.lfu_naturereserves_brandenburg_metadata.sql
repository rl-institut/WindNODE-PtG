-- metadata
COMMENT ON TABLE environment.lfu_naturereserves_brandenburg IS '{
    "title": " Naturschutzgebiete des Landes Brandenburg als Polygongeometrie (MultiPolygon)",
    "description": "Der Datenbestand umfasst die Naturschutzgebiete nach Naturschutzrecht des Landes Brandenburg.",
    "language": [ "ger" ],
    "spatial": 
        {"location": "none",
        "extent": "Brandenburg",
    ...
    "resources": [
        {"name": "environment.lfu_naturereserves_brandenburg",
        "format": "PostgreSQL",
        "fields": [
...
-- select description
SELECT obj_description('environment.lfu_naturereserves_brandenburg' ::regclass) ::json;
