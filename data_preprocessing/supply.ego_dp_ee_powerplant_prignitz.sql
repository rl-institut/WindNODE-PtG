-- metadata
COMMENT ON TABLE supply.ego_dp_ee_powerplant_prignitz IS '{
    "title": "Wind- und PV-Anlagen in der Untersuchungsregion Prignitz",
    "description": "Liste der Wind- und PV-Anlagen in der Untersuchungsregion Prignitz des eGo-Projekts",
    "language": [ "eng", "ger" ],
    "spatial": 
...
-- select description
SELECT obj_description('supply.ego_dp_ee_powerplant_prignitz' ::regclass) ::json;
